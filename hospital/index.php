...
<html lang="en" dir="ltr">
    ...
    <div class="top-container">
      ...
      <nav class="navbar navbar-light bg-light navbar-expand-lg ">
        ...
        <div class="d-flex" style="margin-right: 40px;">
         ...
         <a class="nav-link active" aria-current="page" href="aboutus.php">Developers</a>
        </div>
  ...
  <div>
    ...
    <div class="middle-container">
      <center><b><h1 style="font-family: 'Times New Roman', cursive; margin-bottom:0px; margin-top:25px; font-size: 55px; color:white;">Welcome to KMRB Group of Hospitals</h1></b></center>
