...
<br><br>
  ...
  <div id="homepage" class="tabcontent" style="margin-left:0px; margin-top:0px; margin-right:0px; margin-bottom: 0px; background-color:#FAFAF9 ;">
    ...
    <div style="margin-left:250px;">
      ...
      <p class="lead" style="color:black;">Not feeling well? Book an appointment! Reach out to us to share your concerns. Keep a track of your appointments and profile.</p>
      <hr class="my-4">
