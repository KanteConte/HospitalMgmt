...
<html lang="en" dir="ltr">
  ...
  <body style="height:600px; background: linear-gradient(to bottom, rgba(255,255,255,0.15) 0%, rgba(0,0,0,0.15) 100%), radial-gradient(at top center, rgba(255,255,255,0.40) 0%, rgba(0,0,0,0.40) 120%) #989898;
 background-blend-mode: multiply,multiply; ">
<div class="card" style="width: 77rem; margin: 150px auto 0px auto;">
                <form style="width: 50%;  padding: 0px 20px 0px 20px;  margin:20px auto 0px auto;"
                action="" method="POST">
